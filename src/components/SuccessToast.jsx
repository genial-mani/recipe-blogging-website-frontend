...
const SuccessToast = ({message}) => {
  ...
  return (
    <div className='w-0 h-0'>
        ...
        <svg onClick={closeToast} className='close-toast absolute top-1 right-1 cursor-pointer' height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#393a37"></path></svg>
        <div className='progress-bar w-full absolute bg-slate-700 h-1 bottom-0 right-0'></div>
        </div>
    </div>
  )
}
